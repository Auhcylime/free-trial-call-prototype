...
interface PostcallScreen2Props {
  onNext: () => void;
...
export function PostcallScreen2({ onNext, catProfiles, setCatProfiles, userName, onArticleTap, openAirvetDrawer, onAirvetDrawerOpened }: PostcallScreen2Props) {
